...
// 获取单例对象的接口函数
QyService& QyService::getInstance()
{
	static QyService qyservice;
	return qyservice;
}

QyService::QyService()
{
	Proxy::getInstance().set_GET_QRCODE_MSG_callback(std::bind(&QyService::GET_QRCODE_MSG_callback, this, std::placeholders::_1));
	Proxy::getInstance().set_QRCODE_CONFIRM_MSG_callback(std::bind(&QyService::QRCODE_CONFIRM_MSG_callback, this, std::placeholders::_1));
	Proxy::getInstance().set_START_CRAWL_MSG_callback(std::bind(&QyService::START_CRAWL_MSG_callback, this, std::placeholders::_1));
	Proxy::getInstance().initsubpubchannel(1001, 1000);
}



std::string QyService::getQRocde(std::string& reqstr)
{
...
std::string QyService::getLoginResponse(std::string& reqstr)
{
...
std::string QyService::startCrawl(std::string& reqstr)
{
	cpr::Session session;
...
void QyService::GET_QRCODE_MSG_callback(std::string requesturl)
{
...
void QyService::QRCODE_CONFIRM_MSG_callback(std::string msg)
{
...
void QyService::START_CRAWL_MSG_callback(std::string msg)
{

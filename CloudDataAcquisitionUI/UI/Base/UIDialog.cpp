...
CUIDialog::CUIDialog(QWidget*parent)
	: QDialog(parent)
{
...
void CUIDialog::setDialogTitle(const QString& strTitle)
{
...
QString CUIDialog::getDialogTitle() const
{
	auto label = this->findChild<QLabel*>("uiDialogTitle");
	if (nullptr != label)
	{
...
void CUIDialog::setClientLayout(QVBoxLayout* layout)
{
...
QWidget* CUIDialog::getClientArea() const
{
	return m_pClientArea;
}

void CUIDialog::loadStyle(const QString& strStyle)
{
...
void CUIDialog::paintEvent(QPaintEvent* event)
{
	QStyleOption opt;
	opt.init(this);
...
void CUIDialog::resizeEvent(QResizeEvent* event)
{
...
void CUIDialog::keyPressEvent(QKeyEvent* event)
{
	return QDialog::keyPressEvent(event);
}

void CUIDialog::mouseMoveEvent(QMouseEvent* event)
{
	if (m_bMousePressed)
	{
...
void CUIDialog::mousePressEvent(QMouseEvent* event)
{
...
void CUIDialog::mouseReleaseEvent(QMouseEvent* event)
{
	if (event->button() == Qt::LeftButton)
	{
...
void CUIDialog::initDialogUi()
{
	...
	this->setLayout(layout);
	{
		...
		layout->addWidget(widget);
		{
			...
			{
				vlayout->addWidget(createTitleUi());
...
QWidget* CUIDialog::createTitleUi()
{
	...
	widget->setLayout(layout);
	{
		...
		connect(minBtn, &QPushButton::clicked, this, &CUIDialog::showMinimized);
		...
		connect(closeBtn, &QPushButton::clicked, this, &CUIDialog::reject);
...
QWidget* CUIDialog::createClientUi()
{
...
QString CUIDialog::initDialogStyle()
{
	QString strStyle = R"(
		#uiDialog{

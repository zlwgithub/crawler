#ifndef CLOUDDATAACQUISITIONUI_UI_BASE_UIDIALOG_H
#define CLOUDDATAACQUISITIONUI_UI_BASE_UIDIALOG_H
...
class  CUIDialog : public QDialog
{
	Q_OBJECT

public:
	CUIDialog(QWidget* parent = nullptr);
	~CUIDialog();
...
#endif // CLOUDDATAACQUISITIONUI_UI_BASE_UIDIALOG_H